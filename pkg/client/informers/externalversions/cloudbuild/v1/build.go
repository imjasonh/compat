...
import (
	...
	versioned "github.com/ImJasonH/compat/pkg/client/clientset/versioned"
	internalinterfaces "github.com/ImJasonH/compat/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/ImJasonH/compat/pkg/client/listers/cloudbuild/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudbuildV1().Builds(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudbuildV1().Builds(namespace).Watch(options)
			},
		},
		&cloudbuildv1.Build{},
		resyncPeriod,
...
func (f *buildInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudbuildv1.Build{}, f.defaultInformer)
}
